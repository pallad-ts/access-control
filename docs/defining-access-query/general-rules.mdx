...
For example, based on the [tutorial](/tutorial) it is impossible to define access control policies based on IP address of the request. There is no such information in the query and Access Control Policy is not able to retrieve it somehow.
